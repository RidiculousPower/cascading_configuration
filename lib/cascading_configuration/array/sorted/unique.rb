...
module ::CascadingConfiguration::Array::Sorted::Unique
  ...
  sorted_unique_array_module = ::CascadingConfiguration::Module::BlockConfigurations::ExtendableConfigurations::
  ...
  ::CascadingConfiguration.enable_instance_as_cascading_configuration_module( self, sorted_unique_array_module )
