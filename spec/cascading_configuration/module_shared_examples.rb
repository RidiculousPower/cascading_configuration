...
shared_examples_for :configuration_module do
  ...
  context '#cascading_method_name' do
    let( :cascading_method_name ) { instance.cascading_method_name( 'some_name' ) }
  ...
  context '#singleton_method_name' do
    let( :singleton_method_name ) { instance.singleton_method_name( 'some_name' ) }
  ...
  context '#module_method_name' do
    let( :module_method_name ) { instance.module_method_name( 'some_name' ) }
  ...
  context '#class_method_name' do
    let( :class_method_name ) { instance.class_method_name( 'some_name' ) }
  ...
  context '#instance_method_name' do
    let( :instance_method_name ) { instance.instance_method_name( 'some_name' ) }
  ...
  context '#object_method_name' do
    let( :object_method_name ) { instance.object_method_name( 'some_name' ) }
  ...
  context '#local_instance_method_name' do
    let( :local_instance_method_name ) { instance.local_instance_method_name( 'some_name' ) }
