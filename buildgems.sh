...
CASCADING_CONFIGURATION_DEFINITION=$CASCADING_CONFIGURATION/definition
...
cd $CASCADING_CONFIGURATION_DEFINITION
gem build cascading-configuration-definition.gemspec
mv cascading-configuration-definition*.gem $GEMS/
